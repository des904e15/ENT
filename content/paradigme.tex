\section{Analyse, design and enact(ADE) eller consider, do and adjust(CDA)}\label{paradigme}
...
ADE minder i høj grad om traditionel software udvikling, idet der forsøges at planlægge og designe således at der vil forekomme færre uforudsete problemer.
...
Efter første udrulning vil der derimod kunne indføres en iterativ tilgang, når først vi har opbygget et tillidsforhold med vore kunder.

\paragraph{Understanding of future:}
Vi vil gerne styre fremtiden, altså sætte en høj standard for sikkerhed som andre vil have svært ved at følge.
Dermed skal vi være gode til at tilpasse os, så vores produkt følger de stigende/ændrede generelle sikkerhedskrav.
...
\paragraph{Role of business planning:} Vi har ikke råd til fejl her.
Får vi først leveret en dårlig løsning, vil vores (potentielle) kunder få svært ved at have tillid til os efterfølgende.
...
Vores produkt er som sagt ikke nyskabende, vi forsøger istedet at kombinere eksisterende løsninger og sælge dem til et nyt marked.

\paragraph{Approach to intellectual property:} Platformen er lukket, men de enkelte dele er åbne.
Vi prøver ikke at opfinde noget nyt, men forsøger derimod at skabe en platform til bedre at kune udnytte de eksisterende teknologier i det nyskabte marked.

\paragraph{Partnering and Networking:} Netværk og samarbejde er godt. Se `Approach to others working in the same areas'.
