...
\begin{document}
\maketitle
\todo{Skal vi tilføje kontor og et kontor/rum til demo-setup som en ressource og evt. en aktivitet i mobilize som hedder at finde det rigtige faciliteter?}
...
\todo{Skal vi have det her med: ``You may discuss your design approach (e.g. Customer Insights or Scenarios) using relevant concepts from the course notes''}
